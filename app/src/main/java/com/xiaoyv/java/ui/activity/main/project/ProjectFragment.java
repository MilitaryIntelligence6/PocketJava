...
public class ProjectFragment
        extends BaseFragment<ProjectContract.Presenter>
...
//        mLoadFileCallBack = (LoadFileCallBack) context;
//    }
    ...
    public void onAttach(@NonNull Activity activity) {
        ...
        mLoadFileCallBack = (LoadFileCallBack) activity;
    }
    ...
    public void openFile(File file) {
        ToastUtils.showShort(file.toString() + "hello file");
        mLoadFileCallBack.load(file);
    }
