...
public class MainFragment
        extends BaseFragment<MainContract.Presenter>
    ...
    public BottomNavigationView getMainBottomNavView() {
        return mainBottomNavView;
    }

    public void setMainBottomNavView(BottomNavigationView mainBottomNavView) {
    ...
    public void setFunctionFragment(FunctionFragment functionFragment) {
